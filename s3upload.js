...
(function() {
  window.S3Upload = (function() {
    ...
    S3Upload.prototype.files_element = null;

    S3Upload.prototype.upload_files = null;
    ...
    function S3Upload(options) {
      ...
      if (this.upload_files) {
        this.handleFileSelect(this.upload_files);
      } else {
        this.handleFileSelect(this.files_element.files);
      }
    }
